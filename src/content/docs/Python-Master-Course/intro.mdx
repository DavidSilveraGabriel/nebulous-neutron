---
title: Documentación del Curso de Python (Desde Cero hasta Avanzado)
description: Aprende Python desde cero hasta dominar conceptos avanzados, siguiendo las mejores prácticas (PEP-8).
---
...
<CardGrid>
  <Card title="¡Bienvenido al Curso de Python!" icon="rocket">
    Un viaje desde los fundamentos hasta las técnicas avanzadas de Python.
  </Card>
  <Card title="Domina Python" icon="code">
    Conviértete en un programador competente y capaz de desarrollar aplicaciones eficientes.
  </Card>
</CardGrid>

<Aside type="note" title="Importante 📝">
  Este curso está diseñado para llevarte paso a paso desde los conceptos más básicos hasta el dominio de Python.
</Aside>
